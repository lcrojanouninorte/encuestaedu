      ...
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="button">
              <div><!--[if mso]>
                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ 'https://obsriomagdalena.uninorte.edu.co/plataforma/#/auth/reset-password?reset_password_token='. $token  }}" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#ffffff" fillcolor="#ff6f6f">
                  <w:anchorlock/>
              ...
              <![endif]--><a class="button-mobile" href="{{  'https://obsriomagdalena.uninorte.edu.co/plataforma/#/auth/reset-password?reset_password_token='. $token  }}"
